...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bracex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11467&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bracex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bracex` can be installed with:

```
conda install bracex
```

It is possible to list all of the versions of `bracex` available on your platform with:
